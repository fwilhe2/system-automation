...
def significant_stderr(err):
    # Node.js prints deprecation warnings (e.g. [DEP0005] Buffer(),
    # [DEP0169] url.parse()) to stderr even when the command succeeds;
    # they must not be treated as errors.
